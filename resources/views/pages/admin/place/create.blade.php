...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tambah Places</h1>
        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" name="office_hours"
                                    placeholder="Masukan Jam Kerja" value="{{ old('office_hours') }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" name="phone" placeholder="Masukan Phone"
                                    value="{{ old('phone') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" name="website" placeholder="Masukan Website"
                                    value="{{ old('website') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control map-input" name="latitude" id="latitude"
                                    placeholder="Masukan Latitude" readOnly value="{{ old('latitude') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label for="longitude">Longitude</label>
                                <input type="text" class="form-control map-inpu" id="longitude" name="longitude"
                                    placeholder="Masukan Longitude" readOnly value="{{ old('longitude') }}">
                            </div>
                        </div>
